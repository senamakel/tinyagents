...
//!
//! These are the tree types the [`crate::parser`] produces from a
//! token stream and the [`crate::compiler`] lowers into a
//! [`crate::types::Blueprint`]. They describe a *declared* workflow —
...
//!
//! The AST is re-exported from [`crate::types`] for back-compatibility,
//! so existing `crate::types::{Program, NodeDecl, …}` paths keep
//! resolving.

use serde::{Deserialize, Serialize};

// The source [`Span`] type lives in [`crate::span`].
...
/// [`crate::compiler::compile`] **rejects** any node carrying this
