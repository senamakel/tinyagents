...
use crate::compiler::{compile, compile_with_provenance};
use crate::parser::parse_str;
use crate::types::{Blueprint, NodeSpec, Origin, Routing};
...
/// # Errors
///
/// Propagates [`tinyagents_harness::error::TinyAgentsError::Parse`] from the parser and
/// [`tinyagents_harness::error::TinyAgentsError::Compile`] from the compiler.
