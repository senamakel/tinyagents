...
impl ModelCatalog {
    ...
    /// Hydrates a runtime
    /// [`ModelProfile`][tinyinference_core::model::ModelProfile] from the catalog
    ...
    pub fn profile(
        ...
        provider: &str,
        model_id: &str,
    ) -> Option<tinyinference_core::model::ModelProfile> {
...
fn profile_from_entry(entry: &ModelCatalogEntry) -> tinyinference_core::model::ModelProfile {
    use tinyinference_core::model::{Modalities, ModelProfile, ModelStatus};
