...
/// [`ModelRequest::model`][tinyinference_core::model::ModelRequest::model] to each
...
/// [`ModelRequest::tools`][tinyinference_core::model::ModelRequest::tools] for which
...
/// [`ModelRequest::messages`][tinyinference_core::model::ModelRequest::messages].
///
