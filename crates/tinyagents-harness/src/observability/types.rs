...
//! [`crate::events`] to add **durability**: an envelope
...
use crate::events::{AgentEvent, EventListener, HarnessRunStatus};
use crate::ids::{CallId, EventId, RunId, now_ms};
...
///
/// Where [`crate::events::EventRecord`] is the lightweight,
...
/// enabled, every
/// [`ModelCompleted`][crate::events::AgentEvent::ModelCompleted]
...
/// [`crate::store::JsonlAppendStore`] for a local durable journal or
/// [`crate::store::InMemoryAppendStore`] for deterministic tests.
#[derive(Clone, Debug)]
...
/// [`JsonlAppendStore`](crate::store::JsonlAppendStore) stream.
///
