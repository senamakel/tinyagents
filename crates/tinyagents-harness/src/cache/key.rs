...
//! [`cache_identity`][tinyinference_llm::model::ChatModel::cache_identity] plus the
...
/// [`ChatModel::cache_identity`][tinyinference_llm::model::ChatModel::cache_identity]
...
/// [`cache_identity`][tinyinference_llm::model::ChatModel::cache_identity] string
