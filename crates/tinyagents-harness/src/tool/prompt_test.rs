...
use super::*;
use tinyinference_core::message::{ContentBlock, ImageRef, Message};
...
fn apply_prompt_tool_calls_recovers_attribute_markup() {
    ...
    let resp = tinyinference_core::model::ModelResponse::assistant(
...
fn bare_object_recovery_never_swallows_a_genuine_text_answer() {
    ...
    for text in [
        ...
        let out =
            apply_prompt_tool_calls(tinyinference_core::model::ModelResponse::assistant(text));
        assert!(
