...
/// [`is_retryable`][crate::retry::is_retryable] classification.
///
...
/// [`RetryPolicy::should_retry`][crate::retry::RetryPolicy::should_retry].
///
/// # Examples
///
/// ```
...
pub struct RetryPolicy {
    ...
    /// (`base * (1 ± `[`JITTER_FRACTION`][crate::retry::JITTER_FRACTION]`)`)
    ...
    /// [`is_retryable`][crate::retry::is_retryable].
    ///
...
/// use tinyagents_harness::retry::RateLimiter;
///
