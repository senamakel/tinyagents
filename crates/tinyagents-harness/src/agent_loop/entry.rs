...
impl<State: Send + Sync, Ctx: Send + Sync> AgentHarness<State, Ctx> {
    ...
    /// driven through [`tinyinference_core::model::ChatModel::stream`] rather than
    /// [`tinyinference_core::model::ChatModel::invoke`]: incremental message deltas
    ...
    /// [`tinyinference_core::model::ModelResponse`]. Tool execution, limits, retry,
    ...
    /// [`tinyinference_core::model::ChatModel::stream`] (firing `on_model_delta`
    /// middleware per delta) or the unary
    /// [`tinyinference_core::model::ChatModel::invoke`] path.
