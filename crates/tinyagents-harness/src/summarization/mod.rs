...
impl SummarizationPolicy {
    ...
    /// [`max_input_tokens`][tinyinference_core::model::ModelProfile::max_input_tokens]
    ...
    pub fn from_profile(profile: &tinyinference_core::model::ModelProfile, threshold: f64) -> Self {
        Self {
