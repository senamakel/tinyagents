...
/// - `default_response_format`: when set, attached to every [`tinyinference_core::model::ModelRequest`]
...
pub struct RunPolicy {
    ...
    /// [`tinyinference_core::model::ModelRequest::cache_policy`] does not override
