...
//!
//! [rta]: tinyinference::providers::openai
//! [rj]: tinyinference::providers::openai::relaxed_json
//!
//! # The ladder
//!
...
pub fn parse_lenient(raw: &str) -> Option<(Value, JsonRepair)> {
    ...
    if let Some(value) = tinyagents_tool_call::recover_relaxed_object(unfenced) {
        tinyagents_tracing::debug!(
