...
//! the monolithic `State` + [`crate::StateReducer`] path: instead of one
...
//!   implements [`crate::StateReducer<ChannelState, ChannelUpdate>`], so a
...
///
/// `ChannelState` implements [`crate::StateReducer<ChannelState,
