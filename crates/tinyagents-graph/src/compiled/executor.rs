    ...
    Update: Send + 'static,
{
    ...
    /// [retryable][tinyagents_harness::retry::is_retryable] error, when a
    /// [`RetryPolicy`](tinyagents_harness::retry::RetryPolicy) is configured and
    ...
    /// [`PendingWrite`](crate::checkpoint::PendingWrite)'s docs for why
