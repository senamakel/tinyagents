...
///
/// Recorded when a subgraph node embeds and runs a [`CompiledGraph`](crate::CompiledGraph):
...
/// are surfaced on [`GraphExecution`](crate::GraphExecution) and embedded
...
pub struct ChildRun {
    ...
    #[serde(default)]
    pub usage: tinyinference_core::usage::UsageTotals,
}
...
/// accumulate them onto the final [`GraphExecution`](crate::GraphExecution).
#[derive(Clone, Debug, Default)]
...
/// [`GraphExecution`](crate::GraphExecution).
///
