...
500-line Markdown limit. This file holds the LangChain feature-parity
checklist and the harness's core-type sketch; see the module README for the
package shape and feature index.
